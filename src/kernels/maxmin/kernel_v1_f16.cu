...
// __global__ void max_min_kernel_f16(
//     const __half *__restrict__ A, // [batch, M, K]
//     const __half *__restrict__ B, // [batch, K, N]
//     __half *__restrict__ C_min,   // [batch, M, K, N]
//     __half *__restrict__ C_max,   // [batch, M, N]
//     const int M, const int K, const int N, const int batch_size)
// {

//     extern __shared__ __half mins[];
...
//     if (k < K)
//     {
//         mins[k] = __hmin(A[a_idx], B[b_idx]);
//         C_min[c_min_idx] = mins[k];
//     }
//     else
//     {
//         mins[k] = __float2half(65504.0f);
//     }
//     __syncthreads();
...
// TensorResult maxmin_kernel_v1_f16_wrapper(const TensorResult &tensor_a, const TensorResult &tensor_b)
// {
...
//     // Ejecutar kernel
//     max_min_kernel_f16<<<gridSize, blockSize, shared_mem_size>>>(
